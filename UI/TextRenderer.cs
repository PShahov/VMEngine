...
//            if (Program.vm.Context == null) throw new InvalidOperationException("GraphicsContext не обнаружен");
...
//                    bmp.Dispose();
//                    gfx.Dispose();
//                    if (Program.vm.Context != null) GL.DeleteTexture(texture);
//                }
//                disposed = true;
//            }
//        }
